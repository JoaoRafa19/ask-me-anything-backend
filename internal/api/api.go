		...
		r.Route("/rooms", func(r chi.Router) {
			...
			r.Route("/{room_id}/messages", func(r chi.Router) {
				...
				r.Route("/{message_id}", func(r chi.Router) {
					...
					r.Delete("/react", a.handleRemoveMessageReaction)
...
func (a apiHandler) handleCreateRoomMessages(w http.ResponseWriter, r *http.Request) {
...
func (a apiHandler) handleRemoveMessageReaction(w http.ResponseWriter, r *http.Request) {
